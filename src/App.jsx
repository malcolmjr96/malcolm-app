...
function App() {
    ...
    return (
        <>
            <header>
                <section className="info-plaque">
                    <section className="info">
                        <h2>Malcolm Melbourne</h2>
                        <p>
                            <strong>Hometown:</strong> London, ON, CANADA
                        </p>
                        <p>
                            <strong>Role:</strong> Full Stack Software Developer
                        </p>
                        <p>
                            <strong>Education:</strong> Web Development and
                            Internet Applications
                        </p>
                        <p>
                            <strong>School:</strong> Fanshawe College
                        </p>
                        <p>
                            <strong>Language:</strong> English (Native
                            Proficiency), Korean (Elementary Proficiency)
                        </p>
                    </section>
            ...
            <main>
                    ...
                    <section className="tech-stack-container">
                        <section className="tech-block frontend-container">
                            ...
                            <ul>
                                ...
                                <li className="tech frontend">React Native</li>
                                <li className="tech frontend">Angular</li>
                                <li className="tech frontend">TypeScript</li>
                        ...
                        <section className="tech-block databases-container">
                            ...
                            <ul>
                                ...
                                <li className="tech databases">SQL Server</li>
                        ...
                        <section className="tech-block tools-cloud-container">
                            <h3>Cloud & Tools</h3>
                            <ul>
                                <li className="tech tools-cloud">Git/GitHub</li>
                                <li className="tech tools-cloud">Docker</li>
                                <li className="tech tools-cloud">CloudFlare</li>
                ...
                <section className="experience">
                    ...
                    <section className="experience-item">
                        ...
                        <span className="duration">May 2025 - March 2026</span>
                        <section className="roles">
                            <section className="role-item">
                                <h4>Educational Resource Developer</h4>
                                ...
                                <section className="role-description">
                                    <ul>
                                        <li>
                                            ...
                                            Google Docs into Pressbooks using
                                            HTML/CSS, improving structure,
                                        ...
                                        <li>
                                            ...
                                            to improve usability for diverse
                                            learners
                                        </li>
                                    </ul>
                                </section>
                            ...
                            <section className="role-item">
                                <section className="role-heading">
                                    <h4>FOL Ambassador</h4>
                                    <span className="role-type">Volunteer</span>
                                    <span className="duration">
                                        September 4, 2025 - September 10th, 2025
                                    </span>
                                </section>
                                ...
                                <section className="role-description">
                                    <ul>
                                        <li>
                                            ...
                                            promoted the use of Fanshawe Online
                                            learning tools
                                        </li>
                                        <li>
                            ...
                            <section className="role-item">
                                <section className="role-heading">
                                    <h4>Educational Resource Developer</h4>
                                    <span className="role-type">Seasonal</span>
                                    <span className="duration">
                                ...
                                <section className="role-description">
                                    <ul>
                                        ...
                                        <li>
                                            Supported accessibility and content
                    ...
                    <section className="experience-item">
                        ...
                        <section className="roles">
                            <section className="role-item">
                                <section className="role-heading">
                                    <h4>Email Deliverability Specialist</h4>
                                    <span className="role-type">
                                        Full-Time Permanent
                                    </span>
                                    <span className="duration">
                                ...
                                <section className="role-description">
                                    <ul>
                                        <li>
                                            Provided on-call support during peak
                                            send events, helping maintain
                                            reliable merchant email delivery in
                                            a high-volume production environment
                                        </li>
                                        <li>
                                            Resolved merchant email delivery
                                            issues involving SPF, DKIM, DNS, and
                                            sender authentication
                                        </li>
                                        <li>
                                            Investigated bounce rates, inbox
                                            placement, and domain reputation to
                                            improve deliverability performance
                                        </li>
                                        <li>
                                            Served as escalation specialist for
                                            complex technical cases requiring
                                ...
                                <section className="role-description">
                                    <ul>
                                        <li>
                                            ...
                                            support to merchants using Shopify's
                                            platform
                                        </li>
                                        <li>
                                            Diagnosed platform, configuration,
                                            and workflow issues with high
                                            accuracy
                                        </li>
                                        <li>
                ...
                <section className="awards">
                    ...
                    <section className="awards-item">
                        ...
                        <p>
                            Awarded to Martha Paiz-Domingo and Malcolm Melbourne
                            for TornadoWise, an interactive web-based map
                            visualizing tornado activity and risk across Canada.
                            Recognized for innovation, technical excellence, and
                            contribution to advancing geospatial solutions.
                        </p>
                    </section>
                </section>
